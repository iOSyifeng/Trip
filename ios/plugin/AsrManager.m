...
const NSString* APP_ID = @"17723796";
const NSString* API_KEY = @"p6epA0r177GawIRKYfK9lCbU";
const NSString* SECRET_KEY = @"tFWZwy60Bwzin5FNSg3gmApbhkZGRgg2";

@interface AsrManager () <BDSClientASRDelegate>
@property(strong, nonatomic) BDSEventManager *asrEventManager;
@property(copy, nonatomic) AsrCallback asrSucces;
@property(copy, nonatomic) AsrCallback asrFailure;
